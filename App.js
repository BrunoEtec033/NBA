...
const App = ()=>{
  return (
    <NavigationContainer>
      ...
      >
        <Drawer.Screen name="Minnesota Timberwolves" component={Perfil1} />
        <Drawer.Screen name="Oklahoma City Thunder" component={Perfil2} />
        <Drawer.Screen name="Boston Celtics" component={Perfil3} />
      </Drawer.Navigator>
